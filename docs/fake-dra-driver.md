...
The `hygon` profile mirrors the public `HYGON-AI/k8s-dcu-dra-driver` driver naming (`dra.hygon.com`) and publishes fake DCU devices with `type: dcu`, `cores`, and `memory` capacity.
